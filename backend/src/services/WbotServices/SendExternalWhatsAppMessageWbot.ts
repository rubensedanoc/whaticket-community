...
const SendExternalWhatsAppMessageWbot = async ({
  fromNumber,
  toNumber,
  message,
  ...
  try {
    ...
    console.log("Error en SendExternalWhatsAppMessageWbot", error);
    Sentry.captureException("Error en SendExternalWhatsAppMessageWbot", {
      extra: error
    });
...
export default SendExternalWhatsAppMessageWbot;
